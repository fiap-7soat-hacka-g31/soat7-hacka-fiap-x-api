...
import { GetMyVideoHandler } from './get-my-video.handler';
import { GetMyVideoQuery } from './get-my-video.query';

describe('GetMyVideo', () => {
  let target: GetMyVideoHandler;
  ...
  beforeEach(async () => {
    ...
    target = moduleFixture.get(GetMyVideoHandler);
